...
while True:
    ...
    if working_dir and working_dir[0].isalpha() and working_dir[1]==":" and (working_dir[2]=="\\" or working_dir[2]=="/"):      # ? If 1st char is case insensitive alphabet, 2nd char a `:` & 3rd char is a `/` or `\`.
