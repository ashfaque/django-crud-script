...
""")
    ...
    print("\n##### AUTOGENERATED FIELDS - is_deleted, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by #####")
    while True:
        while True:
            print(f"""\nChoose a field type :-
                    Foreignkey - Press 1
            ...
            if field_type == 0:    # ? Autogenerate is_deleted, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by
